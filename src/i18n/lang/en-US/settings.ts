export default {
  ...
  system: {
    ...
    gomusicAccount: 'GoMusic Account',
    gomusicAccountDesc: 'Login to GoMusic-Node to use upload features',
    gomusicLogin: 'Login',
    gomusicRegister: 'Register',
    gomusicLogout: 'Logout',
    gomusicUsername: 'Username',
    gomusicPassword: 'Password',
    gomusicUsernamePlaceholder: 'Enter username',
    gomusicPasswordPlaceholder: 'Enter password',
    gomusicNoAccount: "Don't have an account? Register",
    gomusicHasAccount: 'Already have an account? Login',
    gomusicLoginSuccess: 'Login successful',
    gomusicRegisterSuccess: 'Registration successful',
    gomusicLoginFailed: 'Login failed',
    gomusicRegisterFailed: 'Registration failed',
    gomusicLogoutSuccess: 'Logged out',
    messages: {
