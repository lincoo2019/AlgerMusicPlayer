export default {
  ...
  system: {
    ...
    gomusicAccount: 'GoMusic 账号',
    gomusicAccountDesc: '登录GoMusic-Node以使用上传功能',
    gomusicLogin: '登录',
    gomusicRegister: '注册',
    gomusicLogout: '退出登录',
    gomusicUsername: '用户名',
    gomusicPassword: '密码',
    gomusicUsernamePlaceholder: '请输入用户名',
    gomusicPasswordPlaceholder: '请输入密码',
    gomusicNoAccount: '没有账号？点击注册',
    gomusicHasAccount: '已有账号？点击登录',
    gomusicLoginSuccess: '登录成功',
    gomusicRegisterSuccess: '注册成功',
    gomusicLoginFailed: '登录失败',
    gomusicRegisterFailed: '注册失败',
    gomusicLogoutSuccess: '已退出登录',
    messages: {
